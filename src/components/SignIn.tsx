  ...
  return (
    <div className="flex flex-col items-center justify-center min-h-screen bg-sky-50 p-4">
      ...
      >
        ...
        {errors.general && (
          <p className="text-red-600 text-sm bg-red-50 border border-red-200 p-3 rounded-lg animate-pulse">
            {errors.general}
          </p>
        )}
        ...
        <button
          type="submit"
          className="bg-blue-600 hover:bg-blue-700 text-white font-bold py-3 rounded-xl transition-all shadow-lg hover:shadow-blue-200 cursor-pointer active:scale-95"
        >
          SIGN IN
        </button>
